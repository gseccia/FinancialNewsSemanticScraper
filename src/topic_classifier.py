...
class TopicClassifier:
    ...
    def classify_news(self, news: str) -> tuple:
        ...
        if self._classes_dict[predicted[0]] is "OtherTopic":
...
if __name__=="__main__":
    ...
    topic_classifier = TopicClassifier(classes_dict=classes,
    ...
    print(topic_classifier.classify_news("CNH Industrial's Iveco unveils first electric truck in partnership with Nikola"))
#     max_words = 400
#     num_classes=4
#
#     filepath_dict = {
...
#     tc.train_and_save(X_train,y_train,X_test,y_test, path="../resources/keras_model_classifier/model2.h5")
#
